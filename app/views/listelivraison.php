...
/* Couleurs pour les statuts (exemple) */
table tr td:last-child[data-status="livré"] {
    color: #27ae60;
}

table tr td:last-child[data-status="en attente"] {
    color: #f39c12;
}

table tr td:last-child[data-status="annulé"] {
    color: #e74c3c;
}
        ...
        <tr>
         ...
         <?php foreach($livraison as $l) { ?>
            <tr>
                ...
                <td><?=$l['chauffeur']?></td>
                <td><?=$l['vehicule']?></td>
                <td data-status="<?=$l['status']?>"><?=$l['status']?></td>
            </tr>
            <?php } ?>
    </table>
</body>
